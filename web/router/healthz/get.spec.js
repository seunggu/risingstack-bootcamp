...
const url = '/healthz';
describe(`GET ${url}`, () => {
  it('should response with 200 when database and redis are healthy', async function () {
  ...
  it('should response with 500 if db is not healthy', async function () {
  ...
  it('should 503 if the process got SIGTERM', async function () {
    this.sandbox.stub(db, 'healthCheck').resolves();
    this.sandbox.stub(redis, 'healthCheck').resolves();
