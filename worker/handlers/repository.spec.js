...
describe('Worker "repository" channel', () => {
  it(`should handle message on the ${CHANNELS.collect.repository.v1} channel`, async function () {
  ...
  it(`should fetch repositories from GitHub & send message to the ${CHANNELS.collect.contributions.v1} channel`, async function () {
    const owner = {
      id: _.random(1000),
      login: 'project-owner',
